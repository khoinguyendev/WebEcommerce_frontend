...
const Header = () => {
  ...
  return (
    <>
              ...
              <div>
                {token ? (
                  <>
                    ...
                    <span className="text-sm font-bold leading-5 text-primary cursor-pointer">{user?.email}</span>
                  </>
                ) : (
                  <>
                    <p className="text-sm">Xin chào!</p>
                    <span className="text-sm font-bold leading-5 text-primary cursor-pointer" onClick={() => setOpenModal(true)}>
                      Đăng nhập
                    </span>
                  </>
                )}
      ...
      {openModal && (isLogin ? <LoginModal setOpenModal={setOpenModal} setIsLogin={setIsLogin} /> : <RegisterModal setOpenModal={setOpenModal} setIsLogin={setIsLogin} />)}
    </>
  );
};
