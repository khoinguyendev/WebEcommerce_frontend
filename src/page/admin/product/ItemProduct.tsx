  ...
  return (
    <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
      ...
      <td className="p-4 space-x-2 whitespace-nowrap">
        <button className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-primary-700 dark:focus:ring-blue-800">
