        ...
        <div className="cart grid grid-cols-12 my-3 gap-3">
          ...
          <div className="col-span-3">
            <div className="flex justify-between">
              ...
              <span className="text-primary font-bold">29.000.000</span>
            </div>
            <div className="mt-5 flex">
              <button className="flex-1 bg-primary text-white py-2 px-4 rounded hover:bg-primary-dark">Thanh toán</button>
            </div>
          </div>
        </div>
      </div>
